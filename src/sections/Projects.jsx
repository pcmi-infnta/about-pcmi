...
const Projects = () => {
  ...
  return (
    <section className="c-space my-0">
      ...
      <p className="head-text mb-10">Join Us</p>

<div className="xl:col-span-2 xl:row-span-3 mb-10">
          <div className="grid-container flex justify-center items-center">
{/* bible-0.gif */}
            <img src="gif/Logo.gif"
 alt="grid-3" className="w-[40%] sm:h-[266px] h-fit object-contain" />
                        <div>
...
We welcome everyone to join our church and partake in our various ministries. Whether looking for spiritual growth, fellowship, or ways to serve the Lord, Pag-ibig Christian Ministries Infanta Quezon has a place for you.
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        ...
        <div className="mt-0"> {/* Added margin-top for spacing */}
          <ContactPcmi />
        </div>
